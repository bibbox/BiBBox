...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(RDConnectEventClp.class.getName())) {
	...
	public static Object translateInputRDConnectEvent(BaseModel<?> oldModel) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"at.graz.meduni.liferay.portlet.bibbox.rdconnect.service.NoSuchRDConnectEventException")) {
	...
	public static Object translateOutputRDConnectEvent(BaseModel<?> oldModel) {
		RDConnectEventClp newModel = new RDConnectEventClp();
