...
/**
 * Provides the local service interface for RDConnectEvent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author reihsr
 * @see RDConnectEventLocalServiceUtil
...
public interface RDConnectEventLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RDConnectEventLocalServiceUtil} to access the r d connect event local service. Add custom service methods to {@link at.graz.meduni.liferay.portlet.bibbox.rdconnect.service.service.impl.RDConnectEventLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
