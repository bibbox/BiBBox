...
/**
 * Provides the local service interface for AddressUpdate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author reihsr
 * @see AddressUpdateLocalServiceUtil
...
public interface AddressUpdateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AddressUpdateLocalServiceUtil} to access the address update local service. Add custom service methods to {@link at.rdconnect.update.service.impl.AddressUpdateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
