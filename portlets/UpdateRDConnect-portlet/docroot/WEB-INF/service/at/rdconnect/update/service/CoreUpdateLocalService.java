...
/**
 * Provides the local service interface for CoreUpdate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author reihsr
 * @see CoreUpdateLocalServiceUtil
...
public interface CoreUpdateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CoreUpdateLocalServiceUtil} to access the core update local service. Add custom service methods to {@link at.rdconnect.update.service.impl.CoreUpdateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
