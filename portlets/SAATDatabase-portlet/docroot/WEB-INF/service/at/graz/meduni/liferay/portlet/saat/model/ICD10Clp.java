...
public class ICD10Clp extends BaseModelImpl<ICD10> implements ICD10 {
	...
	public void setIcd10Id(long icd10Id) {
		...
		if (_icd10RemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setIcd10Id", long.class);

				method.invoke(_icd10RemoteModel, icd10Id);
			}
			catch (Exception e) {
	...
	public int compareTo(ICD10 icd10) {
		...
		if (getIcd10Id() < icd10.getIcd10Id()) {
			value = -1;
		}
		else if (getIcd10Id() > icd10.getIcd10Id()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public String toXmlString() {
		...
		sb.append("at.graz.meduni.liferay.portlet.saat.model.ICD10");
		sb.append("</model-name>");

		sb.append(
			"<column><column-name>icd10Id</column-name><column-value><![CDATA[");
		sb.append(getIcd10Id());
