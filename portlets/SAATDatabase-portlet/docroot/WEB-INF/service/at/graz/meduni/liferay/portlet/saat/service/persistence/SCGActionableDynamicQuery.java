 ...
 * @generated
 */
public abstract class SCGActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SCGActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SCGLocalServiceUtil.getService());
		setClass(SCG.class);

		setClassLoader(at.graz.meduni.liferay.portlet.saat.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("scgId");
	}
}