 ...
 * @generated
 */
public abstract class ICD10ActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ICD10ActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ICD10LocalServiceUtil.getService());
		setClass(ICD10.class);

		setClassLoader(at.graz.meduni.liferay.portlet.saat.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("icd10Id");
	}
}