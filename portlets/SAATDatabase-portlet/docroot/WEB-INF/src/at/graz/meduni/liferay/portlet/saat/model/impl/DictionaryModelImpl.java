 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link at.graz.meduni.liferay.portlet.saat.model.DictionaryModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DictionaryImpl}.
 * </p>
 *
 * @author reihsr
 * @see DictionaryImpl
 * @see at.graz.meduni.liferay.portlet.saat.model.Dictionary
 * @see at.graz.meduni.liferay.portlet.saat.model.DictionaryModel
 * @generated
 */
@JSON(strict = true)
public class DictionaryModelImpl extends BaseModelImpl<Dictionary>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dictionary model instance should use the {@link at.graz.meduni.liferay.portlet.saat.model.Dictionary} interface instead.
	 */
	...
	public static final String TABLE_SQL_CREATE = "create table saat_dictionary (dictionaryId LONG not null primary key,synonym VARCHAR(255) null,before_synonym INTEGER,after_synonym INTEGER,foreword BOOLEAN,ending BOOLEAN,sentence BOOLEAN,iscode BOOLEAN,pattern VARCHAR(255) null,code_typ VARCHAR(75) null,code_value VARCHAR(75) null,root BOOLEAN,negation BOOLEAN,occur BOOLEAN,disease_ids TEXT null,dirty BOOLEAN,priority INTEGER,disease_ids_count INTEGER,priority_mode BOOLEAN)";
	...
	public static long DICTIONARYID_COLUMN_BITMASK = 4L;
