...
import at.graz.meduni.liferay.portlet.saat.NoSuchICD10Exception;
import at.graz.meduni.liferay.portlet.saat.model.ICD10;
import at.graz.meduni.liferay.portlet.saat.model.impl.ICD10Impl;
import at.graz.meduni.liferay.portlet.saat.model.impl.ICD10ModelImpl;
...
public class ICD10PersistenceImpl extends BasePersistenceImpl<ICD10>
	 ...
	 */
	@Override
	public ICD10[] findByCode_PrevAndNext(long icd10Id, String code,
		OrderByComparator orderByComparator)
		throws NoSuchICD10Exception, SystemException {
		ICD10 icd10 = findByPrimaryKey(icd10Id);
	 ...
	 */
	@Override
	public ICD10 create(long icd10Id) {
		ICD10 icd10 = new ICD10Impl();

		icd10.setNew(true);
		icd10.setPrimaryKey(icd10Id);
	 ...
	 */
	@Override
	public ICD10 remove(long icd10Id)
		throws NoSuchICD10Exception, SystemException {
		return remove((Serializable)icd10Id);
	}
	...
	protected ICD10 toUnwrappedModel(ICD10 icd10) {
		...
		icd10Impl.setIcd10Id(icd10.getIcd10Id());
	 ...
	 */
	@Override
	public ICD10 findByPrimaryKey(long icd10Id)
		throws NoSuchICD10Exception, SystemException {
		return findByPrimaryKey((Serializable)icd10Id);
	}
	 ...
	 */
	@Override
	public ICD10 fetchByPrimaryKey(long icd10Id) throws SystemException {
		return fetchByPrimaryKey((Serializable)icd10Id);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.at.graz.meduni.liferay.portlet.saat.model.ICD10")));
