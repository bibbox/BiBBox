...
import at.graz.meduni.liferay.portlet.saat.NoSuchDictionaryDictionaryLinkException;
...
public class DictionaryDictionaryLinkPersistenceImpl extends BasePersistenceImpl<DictionaryDictionaryLink>
	 ...
	 */
	@Override
	public List<DictionaryDictionaryLink> findByDictionaryId(long dictionaryId)
		throws SystemException {
		return findByDictionaryId(dictionaryId, QueryUtil.ALL_POS,
	...
	public List<DictionaryDictionaryLink> findByDictionaryId(
		long dictionaryId, int start, int end) throws SystemException {
		return findByDictionaryId(dictionaryId, start, end, null);
	}
	...
	public List<DictionaryDictionaryLink> findByDictionaryId(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_DICTIONARYID_DICTIONARYID_2);
	...
	public DictionaryDictionaryLink findByDictionaryId_First(
		long dictionaryId, OrderByComparator orderByComparator)
		throws NoSuchDictionaryDictionaryLinkException, SystemException {
		DictionaryDictionaryLink dictionaryDictionaryLink = fetchByDictionaryId_First(dictionaryId,
				orderByComparator);
	...
	public DictionaryDictionaryLink fetchByDictionaryId_First(
		long dictionaryId, OrderByComparator orderByComparator)
		throws SystemException {
		List<DictionaryDictionaryLink> list = findByDictionaryId(dictionaryId,
	 ...
	 */
	@Override
	public DictionaryDictionaryLink findByDictionaryId_Last(long dictionaryId,
		OrderByComparator orderByComparator)
		throws NoSuchDictionaryDictionaryLinkException, SystemException {
		DictionaryDictionaryLink dictionaryDictionaryLink = fetchByDictionaryId_Last(dictionaryId,
				orderByComparator);
	...
	public DictionaryDictionaryLink fetchByDictionaryId_Last(
		long dictionaryId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByDictionaryId(dictionaryId);
	 ...
	 */
	@Override
	public DictionaryDictionaryLink[] findByDictionaryId_PrevAndNext(
		long dictionary_dictionary_addiction_linkId, long dictionaryId,
		OrderByComparator orderByComparator)
		throws NoSuchDictionaryDictionaryLinkException, SystemException {
		DictionaryDictionaryLink dictionaryDictionaryLink = findByPrimaryKey(dictionary_dictionary_addiction_linkId);
	...
	protected DictionaryDictionaryLink getByDictionaryId_PrevAndNext(
		...
		long dictionaryId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByDictionaryId(long dictionaryId)
		throws SystemException {
	 ...
	 */
	@Override
	public int countByDictionaryId(long dictionaryId) throws SystemException {
	...
	private static final String _FINDER_COLUMN_DICTIONARYID_DICTIONARYID_2 = "dictionaryDictionaryLink.dictionaryId = ?";
	 ...
	 */
	@Override
	public DictionaryDictionaryLink create(
		...
		dictionaryDictionaryLink.setPrimaryKey(dictionary_dictionary_addiction_linkId);
	 ...
	 */
	@Override
	public DictionaryDictionaryLink remove(
		long dictionary_dictionary_addiction_linkId)
		throws NoSuchDictionaryDictionaryLinkException, SystemException {
		return remove((Serializable)dictionary_dictionary_addiction_linkId);
	}
	...
	protected DictionaryDictionaryLink toUnwrappedModel(
		...
		dictionaryDictionaryLinkImpl.setDictionary_dictionary_addiction_linkId(dictionaryDictionaryLink.getDictionary_dictionary_addiction_linkId());
		dictionaryDictionaryLinkImpl.setDictionaryId(dictionaryDictionaryLink.getDictionaryId());
		dictionaryDictionaryLinkImpl.setAddictionId(dictionaryDictionaryLink.getAddictionId());
	...
	public DictionaryDictionaryLink findByPrimaryKey(
		long dictionary_dictionary_addiction_linkId)
		throws NoSuchDictionaryDictionaryLinkException, SystemException {
		return findByPrimaryKey((Serializable)dictionary_dictionary_addiction_linkId);
	}
	...
	public DictionaryDictionaryLink fetchByPrimaryKey(
		long dictionary_dictionary_addiction_linkId) throws SystemException {
		return fetchByPrimaryKey((Serializable)dictionary_dictionary_addiction_linkId);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.at.graz.meduni.liferay.portlet.saat.model.DictionaryDictionaryLink")));
