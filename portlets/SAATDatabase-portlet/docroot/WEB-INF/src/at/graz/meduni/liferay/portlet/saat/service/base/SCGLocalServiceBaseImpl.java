...
import at.graz.meduni.liferay.portlet.saat.service.SCGLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.saat.service.impl.SCGLocalServiceImpl}.
 * </p>
 *
 * @author reihsr
...
public abstract class SCGLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.saat.service.SCGLocalServiceUtil} to access the s c g local service.
	 */
	 ...
	 */
	@Override
	public SCG createSCG(long scgId) {
		return scgPersistence.create(scgId);
	}
	...
	@Override
	public SCG deleteSCG(long scgId) throws PortalException, SystemException {
		return scgPersistence.remove(scgId);
	}
	...
	@Override
	public SCG fetchSCG(long scgId) throws SystemException {
		return scgPersistence.fetchByPrimaryKey(scgId);
	}
	 ...
	 */
	@Override
	public SCG getSCG(long scgId) throws PortalException, SystemException {
		return scgPersistence.findByPrimaryKey(scgId);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.meduni.liferay.portlet.saat.model.SCG",
			scgLocalService);
	}
