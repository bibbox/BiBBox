...
import at.graz.meduni.liferay.portlet.saat.NoSuchSCGException;
import at.graz.meduni.liferay.portlet.saat.model.SCG;
import at.graz.meduni.liferay.portlet.saat.model.impl.SCGImpl;
import at.graz.meduni.liferay.portlet.saat.model.impl.SCGModelImpl;
...
public class SCGPersistenceImpl extends BasePersistenceImpl<SCG>
	 ...
	 */
	@Override
	public SCG[] findByCode_PrevAndNext(long scgId, String code,
		OrderByComparator orderByComparator)
		throws NoSuchSCGException, SystemException {
		SCG scg = findByPrimaryKey(scgId);
	 ...
	 */
	@Override
	public SCG create(long scgId) {
		SCG scg = new SCGImpl();

		scg.setNew(true);
		scg.setPrimaryKey(scgId);
	 ...
	 */
	@Override
	public SCG remove(long scgId) throws NoSuchSCGException, SystemException {
	...
	@Override
	public SCG updateImpl(at.graz.meduni.liferay.portlet.saat.model.SCG scg)
		throws SystemException {
		scg = toUnwrappedModel(scg);
	 ...
	 */
	@Override
	public SCG findByPrimaryKey(long scgId)
		throws NoSuchSCGException, SystemException {
	 ...
	 */
	@Override
	public SCG fetchByPrimaryKey(long scgId) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.at.graz.meduni.liferay.portlet.saat.model.SCG")));
