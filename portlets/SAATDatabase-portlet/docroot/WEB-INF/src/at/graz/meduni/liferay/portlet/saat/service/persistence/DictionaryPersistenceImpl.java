...
import at.graz.meduni.liferay.portlet.saat.NoSuchDictionaryException;
...
public class DictionaryPersistenceImpl extends BasePersistenceImpl<Dictionary>
	 ...
	 */
	@Override
	public Dictionary[] findBySynonym_PrevAndNext(long dictionaryId,
	 ...
	 */
	@Override
	public Dictionary[] findByRootNodes_PrevAndNext(long dictionaryId,
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.at.graz.meduni.liferay.portlet.saat.model.Dictionary")));
