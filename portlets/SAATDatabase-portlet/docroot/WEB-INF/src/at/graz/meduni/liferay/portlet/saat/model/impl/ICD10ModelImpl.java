...
import at.graz.meduni.liferay.portlet.saat.model.ICD10Model;
import at.graz.meduni.liferay.portlet.saat.model.ICD10Soap;
...
/**
 * The base model implementation for the ICD10 service. Represents a row in the &quot;saat_code_icd10&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link at.graz.meduni.liferay.portlet.saat.model.ICD10Model} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ICD10Impl}.
 * </p>
 *
 * @author reihsr
 * @see ICD10Impl
 * @see at.graz.meduni.liferay.portlet.saat.model.ICD10
 * @see at.graz.meduni.liferay.portlet.saat.model.ICD10Model
 * @generated
 */
@JSON(strict = true)
public class ICD10ModelImpl extends BaseModelImpl<ICD10> implements ICD10Model {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a i c d10 model instance should use the {@link at.graz.meduni.liferay.portlet.saat.model.ICD10} interface instead.
	 */
	public static final String TABLE_NAME = "saat_code_icd10";
	public static final Object[][] TABLE_COLUMNS = {
			{ "icd10Id", Types.BIGINT },
			{ "code_", Types.VARCHAR },
	...
	public static final String TABLE_SQL_CREATE = "create table saat_code_icd10 (icd10Id LONG not null primary key,code_ VARCHAR(255) null,description TEXT null,INKLUSIVA TEXT null,EXKLUSIVA TEXT null,TYPE TEXT null,USED DOUBLE,FROM_CODE TEXT null,TO_CODE TEXT null)";
	public static final String TABLE_SQL_DROP = "drop table saat_code_icd10";
	public static final String ORDER_BY_JPQL = " ORDER BY icd10.icd10Id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY saat_code_icd10.icd10Id ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.at.graz.meduni.liferay.portlet.saat.model.ICD10"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.at.graz.meduni.liferay.portlet.saat.model.ICD10"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.at.graz.meduni.liferay.portlet.saat.model.ICD10"),
			true);
	public static long CODE_COLUMN_BITMASK = 1L;
	public static long ICD10ID_COLUMN_BITMASK = 2L;
	...
	public static ICD10 toModel(ICD10Soap soapModel) {
		...
		model.setIcd10Id(soapModel.getIcd10Id());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.at.graz.meduni.liferay.portlet.saat.model.ICD10"));
	...
	public Object clone() {
		...
		icd10Impl.setIcd10Id(getIcd10Id());
	...
	public CacheModel<ICD10> toCacheModel() {
		...
		icd10CacheModel.icd10Id = getIcd10Id();
