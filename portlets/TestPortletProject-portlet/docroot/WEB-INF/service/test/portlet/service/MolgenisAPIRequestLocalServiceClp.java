 ...
 * @generated
 */
public class MolgenisAPIRequestLocalServiceClp
	implements MolgenisAPIRequestLocalService {
	public MolgenisAPIRequestLocalServiceClp(
	...
	public test.portlet.model.MolgenisAPIRequest addMolgenisAPIRequest(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(molgenisAPIRequest)
					});
		}
		catch (Throwable t) {
		...
		return (test.portlet.model.MolgenisAPIRequest)ClpSerializer.translateOutput(returnObj);
	}
	...
	public test.portlet.model.MolgenisAPIRequest createMolgenisAPIRequest(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { molgenisapirequestId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<test.portlet.model.MolgenisAPIRequest> getMolgenisAPIRequests(
		...
		return (java.util.List<test.portlet.model.MolgenisAPIRequest>)ClpSerializer.translateOutput(returnObj);
	}
