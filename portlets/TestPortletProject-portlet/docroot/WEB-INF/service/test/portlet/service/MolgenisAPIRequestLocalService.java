...
/**
 * Provides the local service interface for MolgenisAPIRequest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author reihsr
 * @see MolgenisAPIRequestLocalServiceUtil
...
public interface MolgenisAPIRequestLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MolgenisAPIRequestLocalServiceUtil} to access the molgenis a p i request local service. Add custom service methods to {@link test.portlet.service.impl.MolgenisAPIRequestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
