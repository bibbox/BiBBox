 ...
 * @generated
 */
public abstract class D2BiobankActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public D2BiobankActionableDynamicQuery() throws SystemException {
		setBaseLocalService(D2BiobankLocalServiceUtil.getService());
		setClass(D2Biobank.class);

		setClassLoader(at.meduni.liferay.portlet.bbmrieric.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("biobankId");
	}
}