 ...
 * @generated
 */
public abstract class D2CollectionActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public D2CollectionActionableDynamicQuery() throws SystemException {
		setBaseLocalService(D2CollectionLocalServiceUtil.getService());
		setClass(D2Collection.class);

		setClassLoader(at.meduni.liferay.portlet.bbmrieric.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("d2collectionId");
	}
}