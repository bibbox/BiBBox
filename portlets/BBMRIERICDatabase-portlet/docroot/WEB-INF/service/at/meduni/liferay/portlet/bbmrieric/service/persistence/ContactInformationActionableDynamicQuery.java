 ...
 * @generated
 */
public abstract class ContactInformationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ContactInformationActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ContactInformationLocalServiceUtil.getService());
		setClass(ContactInformation.class);

		setClassLoader(at.meduni.liferay.portlet.bbmrieric.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("contactinformationId");
	}
}