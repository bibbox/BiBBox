...
import at.meduni.liferay.portlet.bbmrieric.service.base.D2CollectionServiceBaseImpl;

/**
 * The implementation of the d2 collection remote service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link at.meduni.liferay.portlet.bbmrieric.service.D2CollectionService} interface.
 *
 * <p>
 ...
 */
public class D2CollectionServiceImpl extends D2CollectionServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link at.meduni.liferay.portlet.bbmrieric.service.D2CollectionServiceUtil} to access the d2 collection remote service.
	 */
	...
	public JSONObject getCollections() {
		System.out.print("Starting collection: " );
	...
	public JSONObject getNextCollections(String start) {
		System.out.print("Starting collection from: " + start );
		int s = Integer.valueOf(start);
		JSONObject jsonobject = getMetaDataCollection(s);
		System.out.print("MetaDone");
