...
/**
 * Provides the local service interface for ObjectData. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author reihsr
 * @see ObjectDataLocalServiceUtil
...
public interface ObjectDataLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ObjectDataLocalServiceUtil} to access the object data local service. Add custom service methods to {@link at.graz.hmmc.liferay.portlet.puch.service.impl.ObjectDataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
