 ...
 * @generated
 */
public abstract class ParameterOptionsConfigurationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ParameterOptionsConfigurationActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(ParameterOptionsConfigurationLocalServiceUtil.getService());
		setClass(ParameterOptionsConfiguration.class);

		setClassLoader(at.graz.hmmc.liferay.portlet.puch.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("parameteroptionsconfigurationId");
	}
}