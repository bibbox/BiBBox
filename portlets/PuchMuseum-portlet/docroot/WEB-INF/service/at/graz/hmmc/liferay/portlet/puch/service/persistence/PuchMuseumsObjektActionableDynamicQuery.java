 ...
 * @generated
 */
public abstract class PuchMuseumsObjektActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PuchMuseumsObjektActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PuchMuseumsObjektLocalServiceUtil.getService());
		setClass(PuchMuseumsObjekt.class);

		setClassLoader(at.graz.hmmc.liferay.portlet.puch.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("puchmuseumsobjectId");
	}
}