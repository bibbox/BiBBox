...
/**
 * Provides the local service interface for ParameterOptionsConfiguration. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author reihsr
 * @see ParameterOptionsConfigurationLocalServiceUtil
...
public interface ParameterOptionsConfigurationLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ParameterOptionsConfigurationLocalServiceUtil} to access the parameter options configuration local service. Add custom service methods to {@link at.graz.hmmc.liferay.portlet.puch.service.impl.ParameterOptionsConfigurationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
