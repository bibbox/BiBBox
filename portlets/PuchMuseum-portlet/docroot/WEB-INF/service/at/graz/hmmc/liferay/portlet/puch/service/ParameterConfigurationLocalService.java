...
/**
 * Provides the local service interface for ParameterConfiguration. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author reihsr
 * @see ParameterConfigurationLocalServiceUtil
...
public interface ParameterConfigurationLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ParameterConfigurationLocalServiceUtil} to access the parameter configuration local service. Add custom service methods to {@link at.graz.hmmc.liferay.portlet.puch.service.impl.ParameterConfigurationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
