 ...
 * @generated
 */
public abstract class ObjectDataActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ObjectDataActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ObjectDataLocalServiceUtil.getService());
		setClass(ObjectData.class);

		setClassLoader(at.graz.hmmc.liferay.portlet.puch.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("objectdataId");
	}
}