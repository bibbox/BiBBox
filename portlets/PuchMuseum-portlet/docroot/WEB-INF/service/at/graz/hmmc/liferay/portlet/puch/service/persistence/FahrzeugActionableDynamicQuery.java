 ...
 * @generated
 */
public abstract class FahrzeugActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public FahrzeugActionableDynamicQuery() throws SystemException {
		setBaseLocalService(FahrzeugLocalServiceUtil.getService());
		setClass(Fahrzeug.class);

		setClassLoader(at.graz.hmmc.liferay.portlet.puch.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("fahrzeugId");
	}
}