...
import at.graz.hmmc.liferay.portlet.puch.service.TransaktionDataLocalService;
...
/**
 * Provides the base implementation for the transaktion data local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.hmmc.liferay.portlet.puch.service.impl.TransaktionDataLocalServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class TransaktionDataLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TransaktionDataLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.hmmc.liferay.portlet.puch.service.TransaktionDataLocalServiceUtil} to access the transaktion data local service.
	 */
	...
	@Override
	public TransaktionData addTransaktionData(TransaktionData transaktionData)
		throws SystemException {
		transaktionData.setNew(true);

		return transaktionDataPersistence.update(transaktionData);
	}
	 ...
	 */
	@Override
	public TransaktionData createTransaktionData(long transaktiondataId) {
		return transaktionDataPersistence.create(transaktiondataId);
	}
	...
	@Override
	public TransaktionData deleteTransaktionData(long transaktiondataId)
		throws PortalException, SystemException {
		return transaktionDataPersistence.remove(transaktiondataId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TransaktionData deleteTransaktionData(
		TransaktionData transaktionData) throws SystemException {
		return transaktionDataPersistence.remove(transaktionData);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TransaktionData.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return transaktionDataPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return transaktionDataPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TransaktionData fetchTransaktionData(long transaktiondataId)
		throws SystemException {
		return transaktionDataPersistence.fetchByPrimaryKey(transaktiondataId);
	}
	 ...
	 */
	@Override
	public TransaktionData getTransaktionData(long transaktiondataId)
		throws PortalException, SystemException {
		return transaktionDataPersistence.findByPrimaryKey(transaktiondataId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return transaktionDataPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TransaktionData> getTransaktionDatas(int start, int end)
		throws SystemException {
		return transaktionDataPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTransaktionDatasCount() throws SystemException {
		return transaktionDataPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TransaktionData updateTransaktionData(
		TransaktionData transaktionData) throws SystemException {
		return transaktionDataPersistence.update(transaktionData);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.hmmc.liferay.portlet.puch.model.TransaktionData",
			transaktionDataLocalService);
	}
	...
	private TransaktionDataLocalServiceClpInvoker _clpInvoker = new TransaktionDataLocalServiceClpInvoker();
}