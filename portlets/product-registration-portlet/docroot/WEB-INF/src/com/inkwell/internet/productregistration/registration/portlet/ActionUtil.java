...
public class ActionUtil {
    ...
    public static PRUser prUserFromRequest(ActionRequest request) {
       ...
       PRUser prUser = new PRUserImpl();
        ...
        prUser.setBirthDate(PortalUtil.getDate(birthDateMonth, birthDateDay, birthDateYear));
    ...
    */
    public static PRRegistration prRegistrationFromRequest(ActionRequest request) {
        ...
        registration.setDatePurchased(PortalUtil.getDate(datePurchasedMonth, datePurchasedDay, datePurchasedYear));
