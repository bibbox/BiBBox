 ...
 * @generated
 */
public abstract class EventDataActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public EventDataActionableDynamicQuery() throws SystemException {
		setBaseLocalService(EventDataLocalServiceUtil.getService());
		setClass(EventData.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("eventdataId");
	}
}