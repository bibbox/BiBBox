 ...
 * @generated
 */
public abstract class KdssmpParameterOptionsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public KdssmpParameterOptionsActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(KdssmpParameterOptionsLocalServiceUtil.getService());
		setClass(KdssmpParameterOptions.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("parameteroptionsId");
	}
}