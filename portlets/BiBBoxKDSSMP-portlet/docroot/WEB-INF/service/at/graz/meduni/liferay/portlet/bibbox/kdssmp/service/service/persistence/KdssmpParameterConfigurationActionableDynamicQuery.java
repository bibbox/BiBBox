 ...
 * @generated
 */
public abstract class KdssmpParameterConfigurationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public KdssmpParameterConfigurationActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(KdssmpParameterConfigurationLocalServiceUtil.getService());
		setClass(KdssmpParameterConfiguration.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("parameterconfigurationId");
	}
}