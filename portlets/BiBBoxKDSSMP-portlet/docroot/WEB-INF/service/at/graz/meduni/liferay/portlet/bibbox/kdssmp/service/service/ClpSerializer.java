...
import at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.model.KdssmpPatientClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(KdssmpPatientClp.class.getName())) {
			return translateInputKdssmpPatient(oldModel);
		}
	...
	public static Object translateInputKdssmpPatient(BaseModel<?> oldModel) {
		KdssmpPatientClp oldClpModel = (KdssmpPatientClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getKdssmpPatientRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.model.impl.KdssmpPatientImpl")) {
			return translateOutputKdssmpPatient(oldModel);
		}
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.NoSuchKdssmpPatientException")) {
	...
	public static Object translateOutputKdssmpPatient(BaseModel<?> oldModel) {
		KdssmpPatientClp newModel = new KdssmpPatientClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setKdssmpPatientRemoteModel(oldModel);
