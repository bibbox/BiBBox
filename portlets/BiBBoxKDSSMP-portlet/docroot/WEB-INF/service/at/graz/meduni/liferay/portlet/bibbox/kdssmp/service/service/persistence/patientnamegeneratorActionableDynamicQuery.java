 ...
 * @generated
 */
public abstract class patientnamegeneratorActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public patientnamegeneratorActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(patientnamegeneratorLocalServiceUtil.getService());
		setClass(patientnamegenerator.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("patientnamegeneratorId");
	}
}