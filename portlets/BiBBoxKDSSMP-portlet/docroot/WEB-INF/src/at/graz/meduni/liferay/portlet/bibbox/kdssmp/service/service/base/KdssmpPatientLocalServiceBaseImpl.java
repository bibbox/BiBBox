...
import at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.service.KdssmpPatientLocalService;
...
/**
 * Provides the base implementation for the kdssmp patient local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.service.impl.KdssmpPatientLocalServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class KdssmpPatientLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements KdssmpPatientLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.service.KdssmpPatientLocalServiceUtil} to access the kdssmp patient local service.
	 */
	...
	@Override
	public KdssmpPatient addKdssmpPatient(KdssmpPatient kdssmpPatient)
		throws SystemException {
		kdssmpPatient.setNew(true);

		return kdssmpPatientPersistence.update(kdssmpPatient);
	}
	 ...
	 */
	@Override
	public KdssmpPatient createKdssmpPatient(long patientId) {
		return kdssmpPatientPersistence.create(patientId);
	}
	...
	@Override
	public KdssmpPatient deleteKdssmpPatient(long patientId)
		throws PortalException, SystemException {
		return kdssmpPatientPersistence.remove(patientId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public KdssmpPatient deleteKdssmpPatient(KdssmpPatient kdssmpPatient)
		throws SystemException {
		return kdssmpPatientPersistence.remove(kdssmpPatient);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(KdssmpPatient.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return kdssmpPatientPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return kdssmpPatientPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public KdssmpPatient fetchKdssmpPatient(long patientId)
		throws SystemException {
		return kdssmpPatientPersistence.fetchByPrimaryKey(patientId);
	}
	 ...
	 */
	@Override
	public KdssmpPatient getKdssmpPatient(long patientId)
		throws PortalException, SystemException {
		return kdssmpPatientPersistence.findByPrimaryKey(patientId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return kdssmpPatientPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<KdssmpPatient> getKdssmpPatients(int start, int end)
		throws SystemException {
		return kdssmpPatientPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getKdssmpPatientsCount() throws SystemException {
		return kdssmpPatientPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public KdssmpPatient updateKdssmpPatient(KdssmpPatient kdssmpPatient)
		throws SystemException {
		return kdssmpPatientPersistence.update(kdssmpPatient);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.model.KdssmpPatient",
			kdssmpPatientLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = kdssmpPatientPersistence.getDataSource();
	...
	private KdssmpPatientLocalServiceClpInvoker _clpInvoker = new KdssmpPatientLocalServiceClpInvoker();
}