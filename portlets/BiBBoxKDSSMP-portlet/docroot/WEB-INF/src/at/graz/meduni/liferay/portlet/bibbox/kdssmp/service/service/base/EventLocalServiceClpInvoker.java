...
public class EventLocalServiceClpInvoker {
	public EventLocalServiceClpInvoker() {
		...
		_methodName58 = "createNewEvent";

		_methodParameterTypes58 = new String[] {
				"long", "long", "java.util.Date", "java.lang.String"
			};

		_methodName59 = "getEventsForPatient";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return EventLocalServiceUtil.addEvent((at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.model.Event)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return EventLocalServiceUtil.deleteEvent((at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.model.Event)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return EventLocalServiceUtil.updateEvent((at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.model.Event)arguments[0]);
		}
		...
		if (_methodName58.equals(name) &&
			...
			return EventLocalServiceUtil.createNewEvent(((Long)arguments[0]).longValue(),
