...
<%@ page import="at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.model.KdssmpPatient" %>
<%@ page import="at.graz.meduni.liferay.portlet.bibbox.kdssmp.service.service.KdssmpPatientLocalServiceUtil" %>
