...
if(optionsHorizontalLayout_cfg.equalsIgnoreCase("vertical")) {
	layouttemplate = "Fistname: §FIRSTNAME§<br>Lastname: §LASTNAME§<br>Date of birth: <details id=\"kdssmp_dob\">§DOB§</details> (§AGE§)<br>Gender: §GENDER§";
} else {
	layouttemplate = "Fistname: §FIRSTNAME§&nbsp&nbsp|&nbsp&nbspLastname: §LASTNAME§&nbsp&nbsp|&nbsp&nbspDate of birth: <details id=\"kdssmp_dob\">§DOB§</details> (§AGE§)&nbsp&nbsp|&nbsp&nbspGender: §GENDER§";
}
