...
Create new <b><%= organisationName_option %></b> for <%= parentOrganisationName_option %>:<br><br>
	...
	<aui:fieldset>
		...
		<aui:layout cssClass="bibbox_cs_organisationname">
			<aui:column columnWidth="100" first="true">
				<aui:input name="bibbox_cs_organisationname" label="Patient AZ" type="text" value ="" cssClass="propose" />	
			</aui:column>
			<aui:column columnWidth="100" first="true">
				<% 
