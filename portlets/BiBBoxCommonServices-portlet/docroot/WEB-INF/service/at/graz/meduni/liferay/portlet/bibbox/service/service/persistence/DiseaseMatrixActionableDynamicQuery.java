 ...
 * @generated
 */
public abstract class DiseaseMatrixActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public DiseaseMatrixActionableDynamicQuery() throws SystemException {
		setBaseLocalService(DiseaseMatrixLocalServiceUtil.getService());
		setClass(DiseaseMatrix.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("diseasematrixId");
	}
}