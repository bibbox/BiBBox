 ...
 * @generated
 */
public abstract class ImporterConfigActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ImporterConfigActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ImporterConfigLocalServiceUtil.getService());
		setClass(ImporterConfig.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("importerconfigId");
	}
}