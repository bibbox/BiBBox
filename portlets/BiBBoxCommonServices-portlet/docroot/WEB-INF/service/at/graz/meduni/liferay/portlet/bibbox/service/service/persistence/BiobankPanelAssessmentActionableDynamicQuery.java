 ...
 * @generated
 */
public abstract class BiobankPanelAssessmentActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public BiobankPanelAssessmentActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(BiobankPanelAssessmentLocalServiceUtil.getService());
		setClass(BiobankPanelAssessment.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("biobankpanelassessmentId");
	}
}