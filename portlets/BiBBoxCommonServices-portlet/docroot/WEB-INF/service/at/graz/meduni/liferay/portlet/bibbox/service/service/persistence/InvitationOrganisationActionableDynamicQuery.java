 ...
 * @generated
 */
public abstract class InvitationOrganisationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public InvitationOrganisationActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(InvitationOrganisationLocalServiceUtil.getService());
		setClass(InvitationOrganisation.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("invitationOrganisationId");
	}
}