...
import at.graz.meduni.liferay.portlet.bibbox.service.service.ImporterConfigLocalService;
...
/**
 * Provides the base implementation for the importer config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.bibbox.service.service.impl.ImporterConfigLocalServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class ImporterConfigLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ImporterConfigLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.bibbox.service.service.ImporterConfigLocalServiceUtil} to access the importer config local service.
	 */
	...
	@Override
	public ImporterConfig addImporterConfig(ImporterConfig importerConfig)
		throws SystemException {
		importerConfig.setNew(true);

		return importerConfigPersistence.update(importerConfig);
	}
	 ...
	 */
	@Override
	public ImporterConfig createImporterConfig(long importerconfigId) {
		return importerConfigPersistence.create(importerconfigId);
	}
	...
	@Override
	public ImporterConfig deleteImporterConfig(long importerconfigId)
		throws PortalException, SystemException {
		return importerConfigPersistence.remove(importerconfigId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ImporterConfig deleteImporterConfig(ImporterConfig importerConfig)
		throws SystemException {
		return importerConfigPersistence.remove(importerConfig);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ImporterConfig.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return importerConfigPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return importerConfigPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ImporterConfig fetchImporterConfig(long importerconfigId)
		throws SystemException {
		return importerConfigPersistence.fetchByPrimaryKey(importerconfigId);
	}
	 ...
	 */
	@Override
	public ImporterConfig getImporterConfig(long importerconfigId)
		throws PortalException, SystemException {
		return importerConfigPersistence.findByPrimaryKey(importerconfigId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return importerConfigPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ImporterConfig> getImporterConfigs(int start, int end)
		throws SystemException {
		return importerConfigPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getImporterConfigsCount() throws SystemException {
		return importerConfigPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ImporterConfig updateImporterConfig(ImporterConfig importerConfig)
		throws SystemException {
		return importerConfigPersistence.update(importerConfig);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.meduni.liferay.portlet.bibbox.service.model.ImporterConfig",
			importerConfigLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = importerConfigPersistence.getDataSource();
	...
	private ImporterConfigLocalServiceClpInvoker _clpInvoker = new ImporterConfigLocalServiceClpInvoker();
}