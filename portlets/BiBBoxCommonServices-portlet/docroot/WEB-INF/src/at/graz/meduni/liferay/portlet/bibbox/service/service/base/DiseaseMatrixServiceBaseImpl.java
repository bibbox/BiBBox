...
import at.graz.meduni.liferay.portlet.bibbox.service.service.DiseaseMatrixService;
...
/**
 * Provides the base implementation for the disease matrix remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.bibbox.service.service.impl.DiseaseMatrixServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class DiseaseMatrixServiceBaseImpl extends BaseServiceImpl
	implements DiseaseMatrixService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.bibbox.service.service.DiseaseMatrixServiceUtil} to access the disease matrix remote service.
	 */
	...
	private DiseaseMatrixServiceClpInvoker _clpInvoker = new DiseaseMatrixServiceClpInvoker();
}