 ...
 * @generated
 */
public abstract class OrphanetDisorderActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public OrphanetDisorderActionableDynamicQuery() throws SystemException {
		setBaseLocalService(OrphanetDisorderLocalServiceUtil.getService());
		setClass(OrphanetDisorder.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("orphanetdisorderId");
	}
}