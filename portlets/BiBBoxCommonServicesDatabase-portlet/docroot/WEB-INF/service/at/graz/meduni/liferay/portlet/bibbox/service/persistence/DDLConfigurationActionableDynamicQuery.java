 ...
 * @generated
 */
public abstract class DDLConfigurationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public DDLConfigurationActionableDynamicQuery() throws SystemException {
		setBaseLocalService(DDLConfigurationLocalServiceUtil.getService());
		setClass(DDLConfiguration.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("ddlconfigurationId");
	}
}