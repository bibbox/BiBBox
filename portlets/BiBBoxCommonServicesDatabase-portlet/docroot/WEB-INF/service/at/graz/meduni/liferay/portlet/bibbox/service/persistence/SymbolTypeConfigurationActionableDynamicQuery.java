 ...
 * @generated
 */
public abstract class SymbolTypeConfigurationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SymbolTypeConfigurationActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(SymbolTypeConfigurationLocalServiceUtil.getService());
		setClass(SymbolTypeConfiguration.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("symboltypeconfigurationId");
	}
}