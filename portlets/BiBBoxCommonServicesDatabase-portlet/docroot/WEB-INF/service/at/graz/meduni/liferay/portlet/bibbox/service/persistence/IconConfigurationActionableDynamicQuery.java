 ...
 * @generated
 */
public abstract class IconConfigurationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public IconConfigurationActionableDynamicQuery() throws SystemException {
		setBaseLocalService(IconConfigurationLocalServiceUtil.getService());
		setClass(IconConfiguration.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("iconconfigurationId");
	}
}