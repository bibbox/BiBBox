 ...
 * @generated
 */
public abstract class IconsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public IconsActionableDynamicQuery() throws SystemException {
		setBaseLocalService(IconsLocalServiceUtil.getService());
		setClass(Icons.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("iconsId");
	}
}