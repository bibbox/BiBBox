 ...
 * @generated
 */
public abstract class SymbolConfigurationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SymbolConfigurationActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(SymbolConfigurationLocalServiceUtil.getService());
		setClass(SymbolConfiguration.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("symbolconfigurationId");
	}
}