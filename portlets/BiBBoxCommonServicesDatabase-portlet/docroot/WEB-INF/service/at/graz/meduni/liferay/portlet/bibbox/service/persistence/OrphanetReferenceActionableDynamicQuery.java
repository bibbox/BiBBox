 ...
 * @generated
 */
public abstract class OrphanetReferenceActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public OrphanetReferenceActionableDynamicQuery() throws SystemException {
		setBaseLocalService(OrphanetReferenceLocalServiceUtil.getService());
		setClass(OrphanetReference.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("orphanetreferenceId");
	}
}