...
/**
 * The persistence utility for the gene service. This utility wraps {@link GenePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class GeneUtil {
	 ...
	 */
	public static void clearCache(Gene gene) {
		getPersistence().clearCache(gene);
	}
	 ...
	 */
	public static List<Gene> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static Gene update(Gene gene) throws SystemException {
		return getPersistence().update(gene);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static Gene update(Gene gene, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(gene, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(gene);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(genes);
	}
	...
	* @return the new gene
	*/
	public static at.graz.meduni.liferay.portlet.bibbox.model.Gene create(
		long geneId) {
		return getPersistence().create(geneId);
	}
	...
	*/
	public static at.graz.meduni.liferay.portlet.bibbox.model.Gene remove(
		long geneId)
		throws at.graz.meduni.liferay.portlet.bibbox.NoSuchGeneException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(geneId);
	}

	public static at.graz.meduni.liferay.portlet.bibbox.model.Gene updateImpl(
		at.graz.meduni.liferay.portlet.bibbox.model.Gene gene)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(gene);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static at.graz.meduni.liferay.portlet.bibbox.model.Gene findByPrimaryKey(
		long geneId)
		throws at.graz.meduni.liferay.portlet.bibbox.NoSuchGeneException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(geneId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static at.graz.meduni.liferay.portlet.bibbox.model.Gene fetchByPrimaryKey(
		long geneId) throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(geneId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<at.graz.meduni.liferay.portlet.bibbox.model.Gene> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static GenePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (GenePersistence)PortletBeanLocatorUtil.locate(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.getServletContextName(),
					GenePersistence.class.getName());

			ReferenceRegistry.registerReference(GeneUtil.class, "_persistence");
		}
	 ...
	 */
	public void setPersistence(GenePersistence persistence) {
	}

	private static GenePersistence _persistence;
}