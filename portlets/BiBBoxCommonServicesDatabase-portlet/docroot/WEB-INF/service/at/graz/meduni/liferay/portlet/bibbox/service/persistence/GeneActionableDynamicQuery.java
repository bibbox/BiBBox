 ...
 * @generated
 */
public abstract class GeneActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public GeneActionableDynamicQuery() throws SystemException {
		setBaseLocalService(GeneLocalServiceUtil.getService());
		setClass(Gene.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("geneId");
	}
}