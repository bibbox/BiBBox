 ...
 * @generated
 */
public abstract class GeneReferenceActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public GeneReferenceActionableDynamicQuery() throws SystemException {
		setBaseLocalService(GeneReferenceLocalServiceUtil.getService());
		setClass(GeneReference.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("genereferenceId");
	}
}