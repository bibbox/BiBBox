 ...
 * @generated
 */
public abstract class GeneSynonymActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public GeneSynonymActionableDynamicQuery() throws SystemException {
		setBaseLocalService(GeneSynonymLocalServiceUtil.getService());
		setClass(GeneSynonym.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("genesynonymId");
	}
}