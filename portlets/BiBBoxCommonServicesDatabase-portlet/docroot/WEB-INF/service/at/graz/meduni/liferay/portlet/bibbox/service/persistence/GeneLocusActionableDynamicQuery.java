 ...
 * @generated
 */
public abstract class GeneLocusActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public GeneLocusActionableDynamicQuery() throws SystemException {
		setBaseLocalService(GeneLocusLocalServiceUtil.getService());
		setClass(GeneLocus.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("genelocusId");
	}
}