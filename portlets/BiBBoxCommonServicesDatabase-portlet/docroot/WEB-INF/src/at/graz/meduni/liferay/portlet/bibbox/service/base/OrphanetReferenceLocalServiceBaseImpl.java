...
import at.graz.meduni.liferay.portlet.bibbox.service.OrphanetReferenceLocalService;
...
/**
 * Provides the base implementation for the orphanet reference local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.bibbox.service.impl.OrphanetReferenceLocalServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class OrphanetReferenceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OrphanetReferenceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.bibbox.service.OrphanetReferenceLocalServiceUtil} to access the orphanet reference local service.
	 */
	...
	@Override
	public OrphanetReference addOrphanetReference(
		OrphanetReference orphanetReference) throws SystemException {
		orphanetReference.setNew(true);

		return orphanetReferencePersistence.update(orphanetReference);
	}
	 ...
	 */
	@Override
	public OrphanetReference createOrphanetReference(long orphanetreferenceId) {
		return orphanetReferencePersistence.create(orphanetreferenceId);
	}
	...
	@Override
	public OrphanetReference deleteOrphanetReference(long orphanetreferenceId)
		throws PortalException, SystemException {
		return orphanetReferencePersistence.remove(orphanetreferenceId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OrphanetReference deleteOrphanetReference(
		OrphanetReference orphanetReference) throws SystemException {
		return orphanetReferencePersistence.remove(orphanetReference);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OrphanetReference.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return orphanetReferencePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return orphanetReferencePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public OrphanetReference fetchOrphanetReference(long orphanetreferenceId)
		throws SystemException {
		return orphanetReferencePersistence.fetchByPrimaryKey(orphanetreferenceId);
	}
	 ...
	 */
	@Override
	public OrphanetReference getOrphanetReference(long orphanetreferenceId)
		throws PortalException, SystemException {
		return orphanetReferencePersistence.findByPrimaryKey(orphanetreferenceId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return orphanetReferencePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OrphanetReference> getOrphanetReferences(int start, int end)
		throws SystemException {
		return orphanetReferencePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getOrphanetReferencesCount() throws SystemException {
		return orphanetReferencePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OrphanetReference updateOrphanetReference(
		OrphanetReference orphanetReference) throws SystemException {
		return orphanetReferencePersistence.update(orphanetReference);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.meduni.liferay.portlet.bibbox.model.OrphanetReference",
			orphanetReferenceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = orphanetReferencePersistence.getDataSource();
	...
	private OrphanetReferenceLocalServiceClpInvoker _clpInvoker = new OrphanetReferenceLocalServiceClpInvoker();
}