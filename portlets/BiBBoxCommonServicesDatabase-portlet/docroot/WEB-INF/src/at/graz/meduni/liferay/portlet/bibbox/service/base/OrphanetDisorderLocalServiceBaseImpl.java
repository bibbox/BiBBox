...
import at.graz.meduni.liferay.portlet.bibbox.service.OrphanetDisorderLocalService;
...
/**
 * Provides the base implementation for the orphanet disorder local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.bibbox.service.impl.OrphanetDisorderLocalServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class OrphanetDisorderLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OrphanetDisorderLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.bibbox.service.OrphanetDisorderLocalServiceUtil} to access the orphanet disorder local service.
	 */
	...
	@Override
	public OrphanetDisorder addOrphanetDisorder(
		OrphanetDisorder orphanetDisorder) throws SystemException {
		orphanetDisorder.setNew(true);

		return orphanetDisorderPersistence.update(orphanetDisorder);
	}
	...
	public OrphanetDisorder createOrphanetDisorder(long orphanetdisorderId) {
		return orphanetDisorderPersistence.create(orphanetdisorderId);
	}
	...
	@Override
	public OrphanetDisorder deleteOrphanetDisorder(long orphanetdisorderId)
		throws PortalException, SystemException {
		return orphanetDisorderPersistence.remove(orphanetdisorderId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OrphanetDisorder deleteOrphanetDisorder(
		OrphanetDisorder orphanetDisorder) throws SystemException {
		return orphanetDisorderPersistence.remove(orphanetDisorder);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OrphanetDisorder.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return orphanetDisorderPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return orphanetDisorderPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public OrphanetDisorder fetchOrphanetDisorder(long orphanetdisorderId)
		throws SystemException {
		return orphanetDisorderPersistence.fetchByPrimaryKey(orphanetdisorderId);
	}
	 ...
	 */
	@Override
	public OrphanetDisorder getOrphanetDisorder(long orphanetdisorderId)
		throws PortalException, SystemException {
		return orphanetDisorderPersistence.findByPrimaryKey(orphanetdisorderId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return orphanetDisorderPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OrphanetDisorder> getOrphanetDisorders(int start, int end)
		throws SystemException {
		return orphanetDisorderPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getOrphanetDisordersCount() throws SystemException {
		return orphanetDisorderPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OrphanetDisorder updateOrphanetDisorder(
		OrphanetDisorder orphanetDisorder) throws SystemException {
		return orphanetDisorderPersistence.update(orphanetDisorder);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.meduni.liferay.portlet.bibbox.model.OrphanetDisorder",
			orphanetDisorderLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = orphanetDisorderPersistence.getDataSource();
	...
	private OrphanetDisorderLocalServiceClpInvoker _clpInvoker = new OrphanetDisorderLocalServiceClpInvoker();
}