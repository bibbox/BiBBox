...
import at.graz.meduni.liferay.portlet.bibbox.service.OrphanetSynonymLocalService;
...
/**
 * Provides the base implementation for the orphanet synonym local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.bibbox.service.impl.OrphanetSynonymLocalServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class OrphanetSynonymLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OrphanetSynonymLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.bibbox.service.OrphanetSynonymLocalServiceUtil} to access the orphanet synonym local service.
	 */
	...
	@Override
	public OrphanetSynonym addOrphanetSynonym(OrphanetSynonym orphanetSynonym)
		throws SystemException {
		orphanetSynonym.setNew(true);

		return orphanetSynonymPersistence.update(orphanetSynonym);
	}
	 ...
	 */
	@Override
	public OrphanetSynonym createOrphanetSynonym(long orphanetsynonymId) {
		return orphanetSynonymPersistence.create(orphanetsynonymId);
	}
	...
	@Override
	public OrphanetSynonym deleteOrphanetSynonym(long orphanetsynonymId)
		throws PortalException, SystemException {
		return orphanetSynonymPersistence.remove(orphanetsynonymId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OrphanetSynonym deleteOrphanetSynonym(
		OrphanetSynonym orphanetSynonym) throws SystemException {
		return orphanetSynonymPersistence.remove(orphanetSynonym);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OrphanetSynonym.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return orphanetSynonymPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return orphanetSynonymPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public OrphanetSynonym fetchOrphanetSynonym(long orphanetsynonymId)
		throws SystemException {
		return orphanetSynonymPersistence.fetchByPrimaryKey(orphanetsynonymId);
	}
	 ...
	 */
	@Override
	public OrphanetSynonym getOrphanetSynonym(long orphanetsynonymId)
		throws PortalException, SystemException {
		return orphanetSynonymPersistence.findByPrimaryKey(orphanetsynonymId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return orphanetSynonymPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OrphanetSynonym> getOrphanetSynonyms(int start, int end)
		throws SystemException {
		return orphanetSynonymPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getOrphanetSynonymsCount() throws SystemException {
		return orphanetSynonymPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OrphanetSynonym updateOrphanetSynonym(
		OrphanetSynonym orphanetSynonym) throws SystemException {
		return orphanetSynonymPersistence.update(orphanetSynonym);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.meduni.liferay.portlet.bibbox.model.OrphanetSynonym",
			orphanetSynonymLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = orphanetSynonymPersistence.getDataSource();
	...
	private OrphanetSynonymLocalServiceClpInvoker _clpInvoker = new OrphanetSynonymLocalServiceClpInvoker();
}