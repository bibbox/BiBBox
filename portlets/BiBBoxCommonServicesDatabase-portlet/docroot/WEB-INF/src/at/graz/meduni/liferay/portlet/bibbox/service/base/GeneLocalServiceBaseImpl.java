...
import at.graz.meduni.liferay.portlet.bibbox.service.GeneLocalService;
...
/**
 * Provides the base implementation for the gene local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.bibbox.service.impl.GeneLocalServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class GeneLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements GeneLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.bibbox.service.GeneLocalServiceUtil} to access the gene local service.
	 */
	...
	@Override
	public Gene addGene(Gene gene) throws SystemException {
		gene.setNew(true);

		return genePersistence.update(gene);
	}
	 ...
	 */
	@Override
	public Gene createGene(long geneId) {
		return genePersistence.create(geneId);
	}
	...
	@Override
	public Gene deleteGene(long geneId) throws PortalException, SystemException {
		return genePersistence.remove(geneId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Gene deleteGene(Gene gene) throws SystemException {
		return genePersistence.remove(gene);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Gene.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return genePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return genePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return genePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return genePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Gene fetchGene(long geneId) throws SystemException {
		return genePersistence.fetchByPrimaryKey(geneId);
	}
	 ...
	 */
	@Override
	public Gene getGene(long geneId) throws PortalException, SystemException {
		return genePersistence.findByPrimaryKey(geneId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return genePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Gene> getGenes(int start, int end) throws SystemException {
		return genePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGenesCount() throws SystemException {
		return genePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Gene updateGene(Gene gene) throws SystemException {
		return genePersistence.update(gene);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.meduni.liferay.portlet.bibbox.model.Gene",
			geneLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = genePersistence.getDataSource();
	...
	private GeneLocalServiceClpInvoker _clpInvoker = new GeneLocalServiceClpInvoker();
}