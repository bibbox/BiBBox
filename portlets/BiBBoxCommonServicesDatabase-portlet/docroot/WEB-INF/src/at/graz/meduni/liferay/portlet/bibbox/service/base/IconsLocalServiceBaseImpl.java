...
import at.graz.meduni.liferay.portlet.bibbox.service.IconsLocalService;
...
/**
 * Provides the base implementation for the icons local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.bibbox.service.impl.IconsLocalServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class IconsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements IconsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.bibbox.service.IconsLocalServiceUtil} to access the icons local service.
	 */
	...
	@Override
	public Icons addIcons(Icons icons) throws SystemException {
		icons.setNew(true);

		return iconsPersistence.update(icons);
	}
	 ...
	 */
	@Override
	public Icons createIcons(long iconsId) {
		return iconsPersistence.create(iconsId);
	}
	...
	@Override
	public Icons deleteIcons(long iconsId)
		throws PortalException, SystemException {
		return iconsPersistence.remove(iconsId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Icons deleteIcons(Icons icons) throws SystemException {
		return iconsPersistence.remove(icons);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Icons.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return iconsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return iconsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return iconsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return iconsPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Icons fetchIcons(long iconsId) throws SystemException {
		return iconsPersistence.fetchByPrimaryKey(iconsId);
	}
	 ...
	 */
	@Override
	public Icons getIcons(long iconsId) throws PortalException, SystemException {
		return iconsPersistence.findByPrimaryKey(iconsId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return iconsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Icons> getIconses(int start, int end) throws SystemException {
		return iconsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getIconsesCount() throws SystemException {
		return iconsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Icons updateIcons(Icons icons) throws SystemException {
		return iconsPersistence.update(icons);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.meduni.liferay.portlet.bibbox.model.Icons",
			iconsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = iconsPersistence.getDataSource();
	...
	private IconsLocalServiceClpInvoker _clpInvoker = new IconsLocalServiceClpInvoker();
}