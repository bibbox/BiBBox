...
public class OrphanetSynonymPersistenceImpl extends BasePersistenceImpl<OrphanetSynonym>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ORPHANETDISORDERID =
		new FinderPath(OrphanetSynonymModelImpl.ENTITY_CACHE_ENABLED,
			OrphanetSynonymModelImpl.FINDER_CACHE_ENABLED,
			OrphanetSynonymImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByOrphanetDisorderId",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ORPHANETDISORDERID =
		new FinderPath(OrphanetSynonymModelImpl.ENTITY_CACHE_ENABLED,
			OrphanetSynonymModelImpl.FINDER_CACHE_ENABLED,
			OrphanetSynonymImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByOrphanetDisorderId", new String[] { Long.class.getName() },
			OrphanetSynonymModelImpl.ORPHANETDISORDERID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ORPHANETDISORDERID = new FinderPath(OrphanetSynonymModelImpl.ENTITY_CACHE_ENABLED,
			OrphanetSynonymModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByOrphanetDisorderId", new String[] { Long.class.getName() });
	 ...
	 */
	@Override
	public List<OrphanetSynonym> findByOrphanetDisorderId(
		long orphanetdisorderId) throws SystemException {
		return findByOrphanetDisorderId(orphanetdisorderId, QueryUtil.ALL_POS,
	...
	@Override
	public List<OrphanetSynonym> findByOrphanetDisorderId(
		long orphanetdisorderId, int start, int end) throws SystemException {
		return findByOrphanetDisorderId(orphanetdisorderId, start, end, null);
	}
	...
	public List<OrphanetSynonym> findByOrphanetDisorderId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ORPHANETDISORDERID;
			finderArgs = new Object[] { orphanetdisorderId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_ORPHANETDISORDERID;
		...
		if ((list != null) && !list.isEmpty()) {
			for (OrphanetSynonym orphanetSynonym : list) {
				if ((orphanetdisorderId != orphanetSynonym.getOrphanetdisorderId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_ORPHANETSYNONYM_WHERE);

			query.append(_FINDER_COLUMN_ORPHANETDISORDERID_ORPHANETDISORDERID_2);
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(OrphanetSynonymModelImpl.ORDER_BY_JPQL);
			}
	 ...
	 */
	@Override
	public OrphanetSynonym findByOrphanetDisorderId_First(
		long orphanetdisorderId, OrderByComparator orderByComparator)
		throws NoSuchOrphanetSynonymException, SystemException {
		OrphanetSynonym orphanetSynonym = fetchByOrphanetDisorderId_First(orphanetdisorderId,
				orderByComparator);
		...
		throw new NoSuchOrphanetSynonymException(msg.toString());
	}
	 ...
	 */
	@Override
	public OrphanetSynonym fetchByOrphanetDisorderId_First(
		long orphanetdisorderId, OrderByComparator orderByComparator)
		throws SystemException {
		List<OrphanetSynonym> list = findByOrphanetDisorderId(orphanetdisorderId,
	 ...
	 */
	@Override
	public OrphanetSynonym findByOrphanetDisorderId_Last(
		long orphanetdisorderId, OrderByComparator orderByComparator)
		throws NoSuchOrphanetSynonymException, SystemException {
		OrphanetSynonym orphanetSynonym = fetchByOrphanetDisorderId_Last(orphanetdisorderId,
				orderByComparator);
	 ...
	 */
	@Override
	public OrphanetSynonym fetchByOrphanetDisorderId_Last(
		long orphanetdisorderId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByOrphanetDisorderId(orphanetdisorderId);
	 ...
	 */
	@Override
	public OrphanetSynonym[] findByOrphanetDisorderId_PrevAndNext(
		long orphanetsynonymId, long orphanetdisorderId,
		OrderByComparator orderByComparator)
		throws NoSuchOrphanetSynonymException, SystemException {
		OrphanetSynonym orphanetSynonym = findByPrimaryKey(orphanetsynonymId);
		...
		try {
			...
			OrphanetSynonym[] array = new OrphanetSynonymImpl[3];

			array[0] = getByOrphanetDisorderId_PrevAndNext(session,
					orphanetSynonym, orphanetdisorderId, orderByComparator, true);

			array[1] = orphanetSynonym;

			array[2] = getByOrphanetDisorderId_PrevAndNext(session,
					orphanetSynonym, orphanetdisorderId, orderByComparator,
					false);
	...
	protected OrphanetSynonym getByOrphanetDisorderId_PrevAndNext(
		Session session, OrphanetSynonym orphanetSynonym,
		long orphanetdisorderId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(orphanetSynonym);
		...
		List<OrphanetSynonym> list = q.list();
	...
	public void removeByOrphanetDisorderId(long orphanetdisorderId)
		throws SystemException {
		for (OrphanetSynonym orphanetSynonym : findByOrphanetDisorderId(
				orphanetdisorderId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	public int countByOrphanetDisorderId(long orphanetdisorderId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_ORPHANETDISORDERID;

		Object[] finderArgs = new Object[] { orphanetdisorderId };
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_ORPHANETSYNONYM_WHERE);
	...
	private static final String _FINDER_COLUMN_ORPHANETDISORDERID_ORPHANETDISORDERID_2 =
		"orphanetSynonym.orphanetdisorderId = ?";
	...
	public OrphanetSynonym updateImpl(
		...
		OrphanetSynonymModelImpl orphanetSynonymModelImpl = (OrphanetSynonymModelImpl)orphanetSynonym;
		...
		if (isNew || !OrphanetSynonymModelImpl.COLUMN_BITMASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}

		else {
			if ((orphanetSynonymModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ORPHANETDISORDERID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						orphanetSynonymModelImpl.getOriginalOrphanetdisorderId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_ORPHANETDISORDERID,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ORPHANETDISORDERID,
					args);

				args = new Object[] {
						orphanetSynonymModelImpl.getOrphanetdisorderId()
					};
	...
	private static final String _SQL_SELECT_ORPHANETSYNONYM_WHERE = "SELECT orphanetSynonym FROM OrphanetSynonym orphanetSynonym WHERE ";
	private static final String _SQL_COUNT_ORPHANETSYNONYM = "SELECT COUNT(orphanetSynonym) FROM OrphanetSynonym orphanetSynonym";
	private static final String _SQL_COUNT_ORPHANETSYNONYM_WHERE = "SELECT COUNT(orphanetSynonym) FROM OrphanetSynonym orphanetSynonym WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No OrphanetSynonym exists with the key {";
