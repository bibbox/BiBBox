...
import at.graz.meduni.liferay.portlet.bibbox.service.OrphanetDisorderService;
...
/**
 * Provides the base implementation for the orphanet disorder remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.portlet.bibbox.service.impl.OrphanetDisorderServiceImpl}.
 * </p>
 *
 * @author reihsr
 ...
 * @generated
 */
public abstract class OrphanetDisorderServiceBaseImpl extends BaseServiceImpl
	implements OrphanetDisorderService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.portlet.bibbox.service.OrphanetDisorderServiceUtil} to access the orphanet disorder remote service.
	 */
	...
	private OrphanetDisorderServiceClpInvoker _clpInvoker = new OrphanetDisorderServiceClpInvoker();
}