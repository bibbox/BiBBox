 ...
 * @generated
 */
public abstract class BiobankAttributeListsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public BiobankAttributeListsActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(BiobankAttributeListsLocalServiceUtil.getService());
		setClass(BiobankAttributeLists.class);

		setClassLoader(com.bcnet.portlet.biobank.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("biobankAttributeListsId");
	}
}