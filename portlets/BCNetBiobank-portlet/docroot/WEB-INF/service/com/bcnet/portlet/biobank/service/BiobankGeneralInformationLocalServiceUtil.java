...
/**
 * Provides the local service utility for BiobankGeneralInformation. This utility wraps
 * {@link com.bcnet.portlet.biobank.service.impl.BiobankGeneralInformationLocalServiceImpl} and is the
 ...
 * @generated
 */
public class BiobankGeneralInformationLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.bcnet.portlet.biobank.service.impl.BiobankGeneralInformationLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.bcnet.portlet.biobank.model.BiobankGeneralInformation addBiobankGeneralInformation(
		com.bcnet.portlet.biobank.model.BiobankGeneralInformation biobankGeneralInformation)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addBiobankGeneralInformation(biobankGeneralInformation);
	}
	...
	*/
	public static com.bcnet.portlet.biobank.model.BiobankGeneralInformation createBiobankGeneralInformation(
		long biobankDbId) {
		return getService().createBiobankGeneralInformation(biobankDbId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.bcnet.portlet.biobank.model.BiobankGeneralInformation deleteBiobankGeneralInformation(
		long biobankDbId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteBiobankGeneralInformation(biobankDbId);
	}
	...
	*/
	public static com.bcnet.portlet.biobank.model.BiobankGeneralInformation deleteBiobankGeneralInformation(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .deleteBiobankGeneralInformation(biobankGeneralInformation);
	}
	...
	*/
	...
	public static com.bcnet.portlet.biobank.model.BiobankGeneralInformation fetchBiobankGeneralInformation(
		long biobankDbId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchBiobankGeneralInformation(biobankDbId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.bcnet.portlet.biobank.model.BiobankGeneralInformation getBiobankGeneralInformation(
		long biobankDbId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getBiobankGeneralInformation(biobankDbId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.bcnet.portlet.biobank.model.BiobankGeneralInformation> getBiobankGeneralInformations(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getBiobankGeneralInformations(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getBiobankGeneralInformationsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getBiobankGeneralInformationsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.bcnet.portlet.biobank.model.BiobankGeneralInformation updateBiobankGeneralInformation(
		com.bcnet.portlet.biobank.model.BiobankGeneralInformation biobankGeneralInformation)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateBiobankGeneralInformation(biobankGeneralInformation);
	}
	...
	*/
	...
	public static java.util.List<com.bcnet.portlet.biobank.model.BiobankGeneralInformation> findBiobanksByIdentity(
	...
	public static java.util.List<com.bcnet.portlet.biobank.model.BiobankGeneralInformation> findBiobanksByKeywordsCountry(
		...
		int end) {
		return getService()
				   .findBiobanksByKeywordsCountry(keywords, countryCode, begin,
			end);
	}
	...
	public static BiobankGeneralInformationLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					BiobankGeneralInformationLocalService.class.getName());

			if (invokableLocalService instanceof BiobankGeneralInformationLocalService) {
				_service = (BiobankGeneralInformationLocalService)invokableLocalService;
			}
			else {
				_service = new BiobankGeneralInformationLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(BiobankGeneralInformationLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(BiobankGeneralInformationLocalService service) {
	}

	private static BiobankGeneralInformationLocalService _service;
}