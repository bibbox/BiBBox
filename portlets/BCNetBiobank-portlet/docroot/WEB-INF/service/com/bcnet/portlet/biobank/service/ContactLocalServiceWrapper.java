...
public class ContactLocalServiceWrapper implements ContactLocalService,
	...
	*/
	...
	public com.bcnet.portlet.biobank.model.Contact addContact(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _contactLocalService.addContact(firstName, lastName, phone,
			email, address, zip, city, countryCode, juristicPersonId,
			department, orcId);
	}
	...
	public java.util.List<com.bcnet.portlet.biobank.model.Contact> getAllContacts(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _contactLocalService.getAllContacts(start, end);
	}
	...
	public com.bcnet.portlet.biobank.model.Contact updateContact(
		...
		java.lang.String department, java.lang.String orcId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _contactLocalService.updateContact(contactId, firstName,
			lastName, phone, email, address, zip, city, countryCode,
			juristicPersonId, department, orcId);
	}
