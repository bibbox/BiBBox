 ...
 * @generated
 */
public abstract class BiobankGeneralInformationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public BiobankGeneralInformationActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(BiobankGeneralInformationLocalServiceUtil.getService());
		setClass(BiobankGeneralInformation.class);

		setClassLoader(com.bcnet.portlet.biobank.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("biobankDbId");
	}
}