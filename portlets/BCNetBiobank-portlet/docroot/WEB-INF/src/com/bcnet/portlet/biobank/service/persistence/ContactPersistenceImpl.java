...
import com.bcnet.portlet.biobank.model.impl.ContactImpl;
import com.bcnet.portlet.biobank.model.impl.ContactModelImpl;
...
public class ContactPersistenceImpl extends BasePersistenceImpl<Contact>
	...
	@Override
	public Contact updateImpl(com.bcnet.portlet.biobank.model.Contact contact)
	...
	protected Contact toUnwrappedModel(Contact contact) {
		...
		contactImpl.setCountryCode(contact.getCountryCode());
		contactImpl.setJuristicPersonId(contact.getJuristicPersonId());
		contactImpl.setDepartment(contact.getDepartment());
		contactImpl.setOrcId(contact.getOrcId());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.bcnet.portlet.biobank.model.Contact")));
