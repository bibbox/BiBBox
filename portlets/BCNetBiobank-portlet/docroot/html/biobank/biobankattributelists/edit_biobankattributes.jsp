...
<%
	...
	LiferayPortletURL viewBiobankGeneralInfomrationURL = PortletURLFactoryUtil.create(request, "biobankattributelists_WAR_BCNetBiobankportlet", layout.getPlid(), "RENDER_PHASE");
	viewBiobankGeneralInfomrationURL.setDoAsGroupId(themeDisplay.getSiteGroupId());
	viewBiobankGeneralInfomrationURL.setParameter("jspPage", "/html/biobank/biobankgeneralinformation/view.jsp");
	viewBiobankGeneralInfomrationURL.setWindowState(LiferayWindowState.MAXIMIZED);
%>
<c:set var="portletURL" value="<%=viewBiobankGeneralInfomrationURL%>" />
...
%>
	<aui:button-row>
		...
		<aui:button onClick=" ${portletURL}"  type="cancel" />
	</aui:button-row>
</aui:form>
