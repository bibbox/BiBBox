...
/**
 * Provides the local service interface for MasterCandidateLinkCandidate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Robert Reihs
 * @see MasterCandidateLinkCandidateLocalServiceUtil
...
public interface MasterCandidateLinkCandidateLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MasterCandidateLinkCandidateLocalServiceUtil} to access the master candidate link candidate local service. Add custom service methods to {@link at.meduni.liferay.portlet.rdconnect.service.impl.MasterCandidateLinkCandidateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
