 ...
 * @generated
 */
public abstract class RDCRecommenderActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RDCRecommenderActionableDynamicQuery() throws SystemException {
		setBaseLocalService(RDCRecommenderLocalServiceUtil.getService());
		setClass(RDCRecommender.class);

		setClassLoader(at.meduni.liferay.portlet.rdconnect.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("rdcrecommenderid");
	}
}