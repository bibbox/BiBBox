...
/**
 * Provides the local service interface for AQRRating. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Robert Reihs
 * @see AQRRatingLocalServiceUtil
...
public interface AQRRatingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AQRRatingLocalServiceUtil} to access the a q r rating local service. Add custom service methods to {@link at.meduni.liferay.portlet.rdconnect.service.impl.AQRRatingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
