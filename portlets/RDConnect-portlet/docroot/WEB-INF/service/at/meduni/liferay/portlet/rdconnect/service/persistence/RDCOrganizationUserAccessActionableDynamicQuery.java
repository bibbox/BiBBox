 ...
 * @generated
 */
public abstract class RDCOrganizationUserAccessActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public RDCOrganizationUserAccessActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(RDCOrganizationUserAccessLocalServiceUtil.getService());
		setClass(RDCOrganizationUserAccess.class);

		setClassLoader(at.meduni.liferay.portlet.rdconnect.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("rdcorganizationuseraccessId");
	}
}