 ...
 * @generated
 */
public abstract class AQRRatingActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public AQRRatingActionableDynamicQuery() throws SystemException {
		setBaseLocalService(AQRRatingLocalServiceUtil.getService());
		setClass(AQRRating.class);

		setClassLoader(at.meduni.liferay.portlet.rdconnect.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("aqrId");
	}
}