		...
		<aui:layout cssClass="proposelayout">  
			...
			<aui:column columnWidth="50" last="true">
	 		...
	 		<aui:column columnWidth="50" first="true">
				...
				<aui:input name="diseasesfreetext" type="text" label='Disease Names <span id="rdc-filter-name-help" class="rdc-filter-name-help" title="You can enter multiple diseases with ; separated"><img class="proposerequired" src="/RDConnect-portlet/images/icon_fragezeichen.png" /></span>' value ="<%= diseases_free %>" cssClass="propose" />
			</aui:column>
	 		<aui:column columnWidth="50" last="true">
