...
/**
 * Provides the local service interface for TMA. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author reihsr
 * @see TMALocalServiceUtil
...
public interface TMALocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TMALocalServiceUtil} to access the t m a local service. Add custom service methods to {@link at.meduni.graz.patho.haybaeck.service.impl.TMALocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
