 ...
 * @generated
 */
public abstract class idcardActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public idcardActionableDynamicQuery() throws SystemException {
		setBaseLocalService(idcardLocalServiceUtil.getService());
		setClass(idcard.class);

		setClassLoader(at.graz.meduni.liferay.portlet.bibbox.service.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("idcardId");
	}
}