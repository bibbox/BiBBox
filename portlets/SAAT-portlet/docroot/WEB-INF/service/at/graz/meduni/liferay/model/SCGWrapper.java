...
public class SCGWrapper implements SCG, ModelWrapper<SCG> {
	...
	*/
	...
	/**
	* Returns the ID of this s c g.
	*
	* @return the ID of this s c g
	*/
	@Override
	public long getId() {
		return _scg.getId();
	...
	/**
	* Sets the ID of this s c g.
	*
	* @param id the ID of this s c g
	*/
	@Override
	...
	*/
	...
	@Override
	public int compareTo(at.graz.meduni.liferay.model.SCG scg) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<at.graz.meduni.liferay.model.SCG> toCacheModel() {
		return _scg.toCacheModel();
	}

	@Override
	public at.graz.meduni.liferay.model.SCG toEscapedModel() {
		return new SCGWrapper(_scg.toEscapedModel());
	}

	@Override
	public at.graz.meduni.liferay.model.SCG toUnescapedModel() {
