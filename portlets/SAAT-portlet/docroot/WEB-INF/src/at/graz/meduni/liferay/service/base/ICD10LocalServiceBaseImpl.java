...
import at.graz.meduni.liferay.service.ICD10LocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.liferay.service.impl.ICD10LocalServiceImpl}.
 * </p>
 *
 * @author reihsr
...
public abstract class ICD10LocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.liferay.service.ICD10LocalServiceUtil} to access the i c d10 local service.
	 */
	 ...
	 */
	@Override
	public ICD10 createICD10(long id) {
		return icd10Persistence.create(id);
	}
	...
	@Override
	public ICD10 deleteICD10(long id) throws PortalException, SystemException {
		return icd10Persistence.remove(id);
	}
	...
	@Override
	public ICD10 fetchICD10(long id) throws SystemException {
		return icd10Persistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ICD10 getICD10(long id) throws PortalException, SystemException {
		return icd10Persistence.findByPrimaryKey(id);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("at.graz.meduni.liferay.model.ICD10",
			icd10LocalService);
	}
