...
/**
 * Provides the remote service interface for rdconnect. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author reihsr
 * @see rdconnectServiceUtil
...
public interface rdconnectService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link rdconnectServiceUtil} to access the rdconnect remote service. Add custom service methods to {@link at.graz.meduni.liferay.api.service.impl.rdconnectServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
