<div class="RDConnect" id="main-content" role="main">
		...
		<table class="portlet-layout">
		<tr>
			<td class="aui-w60 portlet-column portlet-column-first" id="column-3">
				$processor.processColumn("column-3", "portlet-column-content portlet-column-content-first")
			</td>
			<td class="aui-w40 portlet-column portlet-column-last" id="column-4">
		...
		<div class="portlet-layout">
			<div class="aui-w60 portlet-column portlet-column-first" id="column-3">
				$processor.processColumn("column-3", "portlet-column-content portlet-column-content-first")
			</div>

			<div class="aui-w40 portlet-column portlet-column-last" id="column-4">
				$processor.processColumn("column-4", "portlet-column-content portlet-column-content-last")
			</div>
		</div>
	#end
