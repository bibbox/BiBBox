...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	<aui:fieldset label="FAQ-Settings">
		<aui:input name="preferences--bbmri_disableSelection--" type="checkbox" value="<%= bbmri_disableSelection %>" />
		<aui:input name="preferences--bbmri_siteId--" type="text" value="<%= bbmri_siteId %>" />
	</aui:fieldset>
