					...
					<#if navcount == 1>
					 <li style="display:inline-block;">
					    <div style="margin: auto;display:inline-block;">
					       <div style="float: left;color: #FFFFFF;font-size: 14px;margin-left: 20px;margin-right: 25px;">The RItrain project is funded by the European Commission, grant agreement number 654156</div>
					    </div>
					 </li>
					</#if>
				</#list>
