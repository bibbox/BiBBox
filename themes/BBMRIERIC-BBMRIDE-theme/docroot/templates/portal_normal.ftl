...
<div class="bbmri_eric_header-maincontainer">
	<div class="bbmri_eric_header-maincontainer-verlauf">
		<div class="bbmri_eric_header-maincontainer-verlauf-inner">
			<img  alt="${logo_description}" height="217px" src="/BBMRIERIC-BBMRIDE-theme/images/header.png" width="1200px" >
		</div>
	</div>
...
<div class="bbmrieric-footer-container">
	<div class="bbmrieric-footer">
		<div class="bbmrieric-footer-twitter"  style="visibility: hidden;">
			<a href="https://twitter.com/BBMRIERIC" target="_blank"><img id="bbmrieric-footer-twitter-slide"  src="/BBMRIERIC-BBMRIDE-theme/images/twitter.png" /></a>
		</div>
		<div class="bbmrieric-footer-linkedin"  style="visibility: hidden;">
			<a href="http://www.linkedin.com/company/bbmri-eric" target="_blank"><img id="bbmrieric-footer-linkedin-slide"  src="/BBMRIERIC-BBMRIDE-theme/images/linkedin.png" /></a>
		</div>
